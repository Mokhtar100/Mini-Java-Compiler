...
public class AnotherGUI extends javax.swing.JFrame {
    ...
    final Boolean WINDOWS_OS = OS.contains("Windows");
    final Boolean Linux_OS = OS.contains("Linux");
    ...
    private void initComponents() {
        ...
        try {
            Image img = ImageIO.read(getClass().getResource("assets/Run1.jpg"));
            jButton4.setIcon(new ImageIcon(img)); // NOI18N
        } catch (Exception e) {
...
//            stt = stt.replaceFirst("style=\"bold\"", "style=\"regular\"");
            ...
            if(WINDOWS_OS) {
                ...
                ProcessBuilder processBuilder = new ProcessBuilder("bash", "-c", "dot -Tpng Dot.dot -oParse.png");
                try {
            ...
            if (msg.contains("line")) {
                ...
                try {
                    Image img = ImageIO.read(getClass().getResource("assets/False.jpg"));
                ...
                try {
                    Image img = ImageIO.read(getClass().getResource("assets/Correct.jpg"));
                    Check.setIcon(new ImageIcon(img));
                } catch (Exception e) {
                    System.out.println(e);
                }
    ...
    private void Windows_OpenPicture() {
        try {
    ...
    private void Linux_OpenPicture() {
        ProcessBuilder processBuilder = new ProcessBuilder("bash", "-c", "xdg-open Parse.png");
        try {
